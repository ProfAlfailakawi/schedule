...
export const GUIDE_FEATURES: GuideFeature[] = [
  ...
  { id:"page.studentRegistration", title:"كشف التسجيل", summary:"ما طلبه الطلبة في الاستبيان، وأين وصل كلُّ مقرّرٍ منه: سُجّل، أو رُدّ ولماذا، أو ما زال ينتظر.", view:"studentRegistration", group:"العمل اليومي", keywords:["تسجيل","طلبة","كشف","مقررات","حالة","رقم الحالة"], version:1 },
  ...
  { id:"schedule.publish.requests", title:"رغبات الأساتذة — إرسال المسوّدات", summary:"يُصدر لكل أستاذٍ رابطَ جدوله هو فيقول رأيه فيه؛ لا يرى جدول غيره، ولا يختار قاعةً، والقرارُ يبقى للقسم. وهو البابُ الوحيد الذي يُعدَّل منه — والبابان الآخران قراءةٌ فقط.", view:"schedules", group:"القرار", keywords:["رغبات","الأساتذة","تعديل","طلب","مسودة","وين يعدل الدكتور","إرسال"], version:1, permission:7, target:"schedule.publish", risk:"sensitive", steps:[{target:"schedule.tool.more",text:"افتح «المزيد» لإظهار أدوات النشر."},{target:"schedule.publish",text:"افتح النشر: فيه ثلاثةُ أبواب، اثنان منها للقراءة."},{target:"schedule.publish.requests",text:"هذا هو «رغبات الأساتذة» — وهو الوحيد الذي يُعدَّل منه. وبطاقةُ الأستاذ بجانبه للاطّلاع وحده، وهي موضعُ الخلط."},{target:"schedule.publish.requests",text:"اكتب آخر موعدٍ لاستقبال الطلبات ثم أصدِر. يصل كلَّ أستاذٍ رابطُه وحده، وتتابع من فتح ومن أرسل في وارد الأساتذة."}] },
