...
export const GUIDE_FEATURES: GuideFeature[] = [
  ...
  { id:"changes.action.deadline", title:"موعد تسليم الجداول", summary:"يضعه رئيس التسجيل مرّةً للفصل، فيظهر صريحاً لكل قسم فوق جدوله.", view:"scheduleChanges", group:"دورة الاعتماد", keywords:["موعد","تسليم","تاريخ","تمديد"], version:1, target:"changes.action.deadline", risk:"write", steps:[{target:"changes.action.deadline",text:"اكتب التاريخ واحفظ. وبعده لا يُستورد ملفٌّ ولا يُنسخ فصل، وتبقى التعديلات الجزئية مفتوحة."}] },
  /* ── رغبات الأساتذة ──────────────────────────────────────────────────────
