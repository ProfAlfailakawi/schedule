...
- **ما كشفه العقد فور إعادة تشغيله (عيبان حقيقيان لا تثبيتان قديمان):**
  ...
  2. خمسة مواضع `animation: pulse … infinite` في ملفات الطبقات: حركة دائمة لا تتوقف. **تُركت كما هي — قرار المالك**: الفصل بين النبض بوصفه تنبيهَ حالة (مبرَّر) والنبض بوصفه زينة دائمة (مُتعِب بصرياً، ويزعج من يضبط `prefers-reduced-motion`) يحتاج قراراً في الذوق لا تعديلاً ميكانيكياً. إن أردت، أضع `@media (prefers-reduced-motion: reduce)` يوقفها جميعاً كحدّ أدنى.
