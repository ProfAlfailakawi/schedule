...
- **ما كشفه العقد فور إعادة تشغيله (عيبان حقيقيان لا تثبيتان قديمان):**
  ...
  2. خمسة مواضع `animation: pulse … infinite` في ملفات الطبقات: حركة دائمة لا تتوقف. **الفصلُ بينها تُرك للمالك، وأرضيةُ السكون نُفِّذت.**
     - *قرارُ المالك الباقي:* أيُّ نبضةٍ تنبيهُ حالةٍ مبرَّر وأيُّها زينةٌ دائمة — هذا ذوقٌ لا تعديلٌ ميكانيكي، وما زال بيدك.
