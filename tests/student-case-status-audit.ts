...
/* رقمُ الحالة مشتقٌّ من معرّف السجلّ في الموضعين — لحظةَ الإرسال وهنا — فلو
   وُلِّد من جديد لاختلف، ولظنّ الطالبُ أنه أرسل مرّتين. */
check((server.match(/String\((?:savedNeed|mine)\.id\)\.slice\(0, 8\)\.toUpperCase\(\)/g) || []).length === 2,
  "ورقمُ الحالة مشتقٌّ من السجلّ نفسِه في الموضعين، لا يُولَّد مرّتين");
