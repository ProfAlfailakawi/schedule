...
ok('139 graduate request keeps approved reason plus a bounded requirement tied to it', 'اكتب متطلباتك بعد اختيار نوع الطلب' in server and 'details:graduateDetails' in server and 'wireGraduateDetails' in server and 'String(item.details||"").trim()' in intel)
