...
ok('73 numeric four-digit branch codes are accepted in preflight', r'(\d{3,4})' in doc_ocr and 'targetSitePrefix.replace(/\\D/g,"")' in server)
...
ok('76 section is never auto-renumbered after parsing', 'Never replace 505/507/... with an invented' in doc_ocr and 'normalizeImportSectionSeries' in intel)
