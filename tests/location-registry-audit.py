...
ok('130v report scope is one switch, not a second copy of every report button', 'query-branch-scope' in reports_branch_ui and 'branchAllSites ? void printBranchComprehensive() : printReport("comprehensive")' in reports_branch_ui and '"يجمع الفروع…" : "الشامل — كل الفروع"' not in reports_branch_ui)
