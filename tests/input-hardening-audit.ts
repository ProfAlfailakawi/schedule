...
if (gapThreshold) {
  ...
  check(reads("100 ساعات") === "100", "«١٠٠ ساعات» تُقرأ ١٠٠ لا ٠٠ — وهذا ما كسره تحديدٌ بلا نظرةٍ خلفية");
  ...
  check(!/\(\\d\+\)\\s\*ساع/.test(serverSource), "لا رجوعَ إلى `(\\d+)\\s*ساع` غير المحدود");
}
