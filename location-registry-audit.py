...
ok('137 multi-page scans reuse the exact one-page OCR pool sequentially without a second engine', 'MULTI-PAGE GOLDEN PATH' in doc_ocr and 'for(let index=0;index<images.length;index++)await processPage(index,pool);' in doc_ocr and 'getFastLaneWorkerPool' not in doc_ocr)
